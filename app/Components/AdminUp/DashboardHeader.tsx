  ...
  return (
    <div>
      ...
      <div className="flex flex-auto justify-between">
        ...
        <div>
          <button className="flex items-center px-4 py-3 mt-6 mr-6 text-white bg-customBlue rounded-md hover:bg-customBlue focus:outline-none focus:ring-2 focus:ring-customBlue">
